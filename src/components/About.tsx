    ...
    <section id="about" className="py-20 px-4 bg-white dark:bg-slate-900">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center">
          <div className="mb-12">
            <div className="w-48 h-48 rounded-2xl overflow-hidden shadow-2xl ring-4 ring-slate-100 dark:ring-slate-800">
              <ImageWithFallback
                src="./images/ANKUSHIMAGE.jpg"
                alt="Ankush Makhijani"
          ...
          <div className="max-w-3xl text-center">
            ...
            <p className="text-slate-600 dark:text-slate-300 mb-8 text-justify">
            ...
            <div className="grid md:grid-cols-3 gap-6 mt-12">
              <div className="bg-slate-50 dark:bg-slate-800 p-6 rounded-xl">
                ...
                <p className="text-slate-800 dark:text-slate-200 mb-1">Location</p>
                <p className="text-slate-600 dark:text-slate-300">San Jose, CA</p>
              </div>
              <div className="bg-slate-50 dark:bg-slate-800 p-6 rounded-xl">
                <div className="w-3 h-3 rounded-full bg-blue-600 mx-auto mb-3"></div>
                <p className="text-slate-800 dark:text-slate-200 mb-1">Email</p>
                <p className="text-slate-600 dark:text-slate-300">makhijaniankush24@gmail.com</p>
              </div>
              <div className="bg-slate-50 dark:bg-slate-800 p-6 rounded-xl">
                <div className="w-3 h-3 rounded-full bg-blue-600 mx-auto mb-3"></div>
                <p className="text-slate-800 dark:text-slate-200 mb-1">Experience</p>
                <p className="text-slate-600 dark:text-slate-300"> 1 Year Professional</p>
              </div>
            </div>
          </div>
        </div>
